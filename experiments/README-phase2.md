...
| **推定測定時間** | 25-26 時間 | 9.5-10.5 時間 | 60% 短縮 |

### 測定時間推定

| 項目 | 推定時間 |
|------|---------|
| **合計推定時間** | **約 9.5 時間**（570 分） |
| 純測定時間 | 545 分 |
| vLLM 再起動オーバーヘッド | 約 53 分（5 回起動） |
| Phase 1 からの削減 | 約 16 時間（60% 削減） |
...
| 項目 | 最適化前（最悪ケース） | 最適化後 |
|------|----------------------|---------|
| 再起動回数 | 最大 49 回 | 4 回（5 回起動） |
| オーバーヘッド時間 | 400-650 分 | 43-63 分 |
| 削減効果 | - | **5-10 時間の時間短縮** |
...
| 4 | L3-TCP standard | 32768 | 11 | 再起動 2 |
| 5 | L2-EFA long_context | 131072 | 3 | 再起動 3 |
| 6 | L3-TCP long_context | 131072 | 3 | 再起動 4 |
| 7 | L4-Analysis | - | 3 | 不要 |

**合計: 5 回の起動（初回起動 + 4 回の再起動）= 20-40 分のオーバーヘッド**
...
| 最適化後（グループ化） | 4 回 | 20-40 分 | **80-160+ 分削減** |
