...
##
## Usage:
##   ./deploy-v8.sh <config-file>
##
## Example:
##   ./deploy-v8.sh configs/v7test-phase3-us-west-2.env
##
...
echo ""
echo "========================================="
echo "Deployment Configuration (v8 - SSM + S3 + Proxy)"
echo "========================================="
...
# Run deployment
TASK_FILE="$SCRIPT_DIR/tasks/complete-deployment-v8.json"
