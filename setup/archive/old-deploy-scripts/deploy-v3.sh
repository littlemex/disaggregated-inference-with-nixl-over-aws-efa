#!/bin/bash
##
## Complete NIXL Deployment Script (v3)
## Producer/Consumer separated configuration
##
## Usage:
##   ./deploy-v3.sh <config-file>
##
## Example:
##   ./deploy-v3.sh configs/phase3-us-west-2-v3.env
##
...
echo ""
echo "========================================="
echo "Deployment Configuration (v3)"
echo "========================================="
...
TASK_FILE="$SCRIPT_DIR/tasks/complete-deployment-v3.json"
