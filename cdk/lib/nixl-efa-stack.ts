  ...
  constructor(scope: Construct, id: string, props: NixlEfaStackProps) {
    ...
    if (mlflowTrackingServerArn) {
      userData.addCommands(
        ...
        "# Fix libibverbs version mismatch: NIXL bundles libibverbs v1.14 (rdmav34) but",
        "# system EFA providers are rdmav59. LD_PRELOAD system libibverbs so UCX+SRD works.",
